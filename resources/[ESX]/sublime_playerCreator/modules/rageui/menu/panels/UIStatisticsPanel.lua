...
function RageUI.StatisticPanel(Percent, Text, Index)
    local Statistics = {
        Background = { Dictionary = "commonmenu", Texture = "gradient_bgd", Y = -41, Width = 431, Height = 42 },
        Text = {
            Left = { X = -40, Y = -33, Scale = 0.28 },
        },
        Bar = { Right = -428, Y = -21, Width = 200, Height = 5, OffsetRatio = 0.5 },
        Divider = {
            [1] = { X = 100, Y = -21, Width = 2, Height = 5 },
            [2] = { X = 100, Y = -21, Width = 2, Height = 5 },
            [3] = { X = 100, Y = -21, Width = 2, Height = 5 },
            [4] = { X = 100, Y = -21, Width = 2, Height = 5 },
            [5] = { X = 100, Y = -21, Width = 2, Height = 5 },
        }
    }
    ...
    if CurrentMenu ~= nil then
        if CurrentMenu() and (Index == nil or (CurrentMenu.Index == Index)) then
            ...
            RenderRectangle(CurrentMenu.X + 436, CurrentMenu.Y + Statistics.Background.Y + CurrentMenu.SubtitleHeight + RageUI.ItemOffset + (RageUI.StatisticPanelCount * 42), Statistics.Background.Width + CurrentMenu.WidthOffset, Statistics.Background.Height, 0, 0, 0, 170)
            RenderText(Text or "", CurrentMenu.X + 440.0, (RageUI.StatisticPanelCount * 40) + CurrentMenu.Y + Statistics.Text.Left.Y + CurrentMenu.SubtitleHeight + RageUI.ItemOffset, 0, Statistics.Text.Left.Scale, 245, 245, 245, 255, 0)
...
function RageUI.StatisticPanelAdvanced(Text, Percent, RGBA1, Percent2, RGBA2, RGBA3, Index)
    local Statistics = {
        ...
        Bar = { Right = 8, Y = 27, Width = 200, Height = 5, OffsetRatio = 0.5 },
        Divider = {
