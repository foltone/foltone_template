...
Config.Strings = {
	...
	JerryCanEmpty = "Le bidon d'essence est vide",
	FullTank = "Le réservoir est plein",
	PurchaseJerryCan = "Appuyez sur ~g~E ~w~pour acheter un jerrican pour ~g~$." .. Config.JerryCanCost,
	CancelFuelingPump = "Appuyez sur ~g~E ~w~pour annuler le ravitaillement en carburant.",
	CancelFuelingJerryCan = "Appuyez sur ~g~E ~w~pour annuler le ravitaillement en carburant.",
	NotEnoughCash = "Pas assez de liquidités",
	RefillJerryCan = "Appuyez sur ~g~E ~w~ pour remplir le jerrican ",
	NotEnoughCashJerryCan = "Pas assez d'argent pour remplir un jerrican",
	JerryCanFull = "Jerrican remplit",
	TotalCost = "Coût",
}
