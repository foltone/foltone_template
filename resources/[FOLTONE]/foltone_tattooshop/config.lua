Config = {
    ...
    CategoriesLabel = {
        {name = "ZONE_HEAD", label = "Tête"},
        {name = "ZONE_TORSO", label = "Torse"},
        {name = "ZONE_HAIR", label = "Crâne"},
        {name = "ZONE_LEFT_ARM", label = "Bras gauche"},
        {name = "ZONE_RIGHT_ARM", label = "Bras droit"},
        {name = "ZONE_LEFT_LEG", label = "Jambe gauche"},
        {name = "ZONE_RIGHT_LEG", label = "Jambe droite"}
    },
    ...
    -- list from https://github.com/iLLeniumStudios/illenium-appearance/blob/0f1eb8f9281c0924c5f872776622d6481c64ae03/shared/tattoos.lua#L2848
    TattoosCategories = {
        ZONE_TORSO = {
            {
                name = "TAT_AR_000",
